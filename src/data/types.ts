...
export interface TestItem {
  ...
  subItems?: string[];
  /** הנחיה קצרה וקבועה על תזמון/הכנה מיוחדת לבדיקה (למשל "יש לבצע בצום") — תוכן קבוע של האתר, לא הזנה של המשתמשת */
  prepNote?: string;
  /** מספר הימים שבהם הבדיקה נחשבת בתוקף מרגע ביצועה. undefined כשהתוקף משתנה בין יחידות/רכיבים ואין ערך אחיד לקבוע */
  validityDays?: number;
}
