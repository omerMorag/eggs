...
export const healthFunds: HealthFundRow[] = [
  {
    ...
    copay: "3,500 ₪ למחזור",
    note: "נדרש בדרך כלל ותק של 12 חודשים במושלם פלטינום, והשירות כולל הקפאה לחמש שנים.",
    source: {
  ...
  },
  {
    ...
    copay: "3,500 ₪ למחזור",
    note:
      "נדרש ותק של 12 חודשים במכבי שלי. נכון לעדכון מרץ 2026, בתי החולים שבהסכם הם שיבא תל השומר ומדיקה אלישע. התרופות אינן כלולות בהשתתפות העצמית, אך עשויה להיות זכאות להנחה ברכישתן.",
    source: {
      label: "תנאי מכבי שלי",
