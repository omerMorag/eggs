 ...
 * הגנרי שבחלק מהשלבים). כעת לכל 7 השלבים יש תרנגולת. שלבים 1, 2 ו-4
 * משתמשים בתרנגולות שכבר קיימות במיפוי המרכזי (משמשות גם באזורים אחרים
 * באתר — "tests" ב"הבדיקות שלי", "choose-clinic" ב"איפה כדאי לעשות?",
 * "consultation" שהיה קודם כהערה נפרדת אחרי שלב 4 והוחלף כעת בשימוש
 * כאייקון השלב עצמו). שלב 3 ("משלימה את דרישות היחידה") מקבל תרנגולת
 * ייעודית חדשה ("step-requirements", לוח קליפ עם וי-ים).
 */
