 ...
 * שאינם ברשימה ממשיכים להציג את האייקון הגנרי הרגיל, בלי שינוי. שלבים 1,
 * 2 ו-4 משתמשים בתרנגולות שכבר קיימות במיפוי המרכזי (משמשות גם באזורים
 * אחרים באתר — "tests" ב"הבדיקות שלי", "choose-clinic" ב"איפה כדאי
 * לעשות?", "consultation" שהיה קודם כהערה נפרדת אחרי שלב 4 והוחלף כעת
 * בשימוש כאייקון השלב עצמו).
 */
