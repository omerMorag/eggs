 ...
 * שאר עמודי האתר (טקסט מול איור התרנגולת — תרנגולת בחלוק וכובע רפואי,
 * `"step-retrieval"`, אותו איור המשמש לשלב 7 בצ'קליסט "המסלול שלי" אך
 * בגודל כותרת-עמוד גדול יותר כאן), ומיד אחריהם כל תוכן המדריך גלוי תמיד
 * (RetrievalDayGuide — ציר זמן, רשימת ציוד, טיפים, אחרי השאיבה).
 *
  ...
  return (
    <div className="print-stack animate-fadeUp">
      <section className="lg:flex lg:items-center lg:justify-between lg:gap-8">
        ...
        {/* התרנגולת עם החלוק (אותו איור המשמש לשלב 7 בצ'קליסט, כאן בגודל כותרת-עמוד) —
            מוצגת במובייל אחרי הכותרת והתקציר, ובדסקטופ בצד הנגדי לטקסט */}
        <div className="no-print mt-4 flex justify-center lg:mt-0 lg:shrink-0 lg:justify-end">
          <HenIllustration
            name="step-retrieval"
            blob="mint"
            sizeClassName="w-[150px] sm:w-[190px] lg:w-[260px]"
          />
        </div>
      </section>
